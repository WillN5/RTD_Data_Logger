...
*/
/**************************************************************************/
bool Adafruit_MAX31865_Modified::begin(max31865_numwires_t wires) {
  spi_dev.begin();
  ...
  // Serial.print("config: ");
  // Serial.println(readRegister8(MAX31856_CONFIG_REG), BIN);
  return true;
}
...
*/
/**************************************************************************/
uint8_t Adafruit_MAX31865_Modified::readFault(void) {
...
*/
/**************************************************************************/
void Adafruit_MAX31865_Modified::clearFault(void) {
...
*/
/**************************************************************************/
void Adafruit_MAX31865_Modified::enableBias(bool b) {
  uint8_t t = readRegister8(MAX31856_CONFIG_REG);
  if (b) {
...
*/
/**************************************************************************/
void Adafruit_MAX31865_Modified::autoConvert(bool b) {
  uint8_t t = readRegister8(MAX31856_CONFIG_REG);
  if (b) {
...
void Adafruit_MAX31865_Modified::enable50Hz(bool b) {
  uint8_t t = readRegister8(MAX31856_CONFIG_REG);
  if (b) {
...
*/
/**************************************************************************/
void Adafruit_MAX31865_Modified::setWires(max31865_numwires_t wires) {
  uint8_t t = readRegister8(MAX31856_CONFIG_REG);
...
*/
/**************************************************************************/
float Adafruit_MAX31865_Modified::temperature(float RTDnominal, float refResistor) {
...
//  Serial.println(rtd);
  ...
  // type cast for calculations
  Rt = (float)rtd;

  // Rt = readRTD(); // Old function with large delays
  Rt /= 32768;
  Rt *= refResistor;
...
*/
/**************************************************************************/
uint16_t Adafruit_MAX31865_Modified::readRTD(void) {
  clearFault();
  enableBias(true);
  delay(10);
  uint8_t t = readRegister8(MAX31856_CONFIG_REG);
...
uint8_t Adafruit_MAX31865_Modified::readRegister8(uint8_t addr) {
  uint8_t ret = 0;
...
uint16_t Adafruit_MAX31865_Modified::readRegister16(uint8_t addr) {
...
void Adafruit_MAX31865_Modified::readRegisterN(uint8_t addr, uint8_t buffer[],
                                      uint8_t n) {
...
void Adafruit_MAX31865_Modified::writeRegister8(uint8_t addr, uint8_t data) {
